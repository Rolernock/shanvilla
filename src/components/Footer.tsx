    ...
    <footer className="bg-foreground text-background py-12">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Hotel Info */}
          <div>
            <h3 className="text-2xl font-bold text-primary-glow mb-4">Shanvilla Hotel</h3>
            <p className="text-background/80 mb-4 leading-relaxed">
              Experience modern luxury and comfort in Murang'a. Where every stay becomes an unforgettable memory.
            </p>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-primary-glow">Contact Information</h4>
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-background/80 text-sm">24/7 Front Desk Service</span>
              </div>
            </div>
          </div>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-primary-glow">Our Services</h4>
